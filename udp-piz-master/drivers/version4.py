...
def tankValve_check():
    ...
    conn = httplib.HTTPConnection(dataList[seg+'_part2_IP'])
    conn.request("GET", "/tankvalve/check/1")
    r1 = conn.getresponse()
    print r1.read()
