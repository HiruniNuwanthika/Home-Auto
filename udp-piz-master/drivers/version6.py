...
def soilvalve_check():
    ...
    conn = httplib.HTTPConnection(dataList[seg+'_part2_IP'])
    conn.request("GET", "/soilvalve/check/1")
    r1 = conn.getresponse()
    print r1.read()
